...
<?php do_action( 'localseomap_before_content' ); ?>
    ...
    <div class="profolio-container profolio-single-wrap p-60-0-30">
        ...
        <div class="profolio-row mb30">
			...
			?>
			<?php if ( ! empty( $project_tag ) || ! empty( $start_date ) || ! empty( $address ) ) : ?>
                <div class="profolio-col-lg-12 mb30">
                    <div class="profolio-elm-title mb15">
                        <span><i class="pro_fa pro_fa-info-circle"></i></span>
                        <b><?php echo esc_html__( 'Story Details','localseomap-for-elementor'); ?></b>
                    </div>

                    <b><?php echo esc_html__( 'Date','localseomap-for-elementor'); ?>:</b>
					<?php echo date( 'F d, Y ', strtotime( $start_date ) ); ?>
                    <br>

                    <b><?php echo esc_html__( 'Location','localseomap-for-elementor'); ?>:</b>
                    ...
                    if ( ! empty( $project_tag ) ) : ?>
                        <b><?php echo esc_html__( 'Tags','localseomap-for-elementor'); ?>:</b>
						<?php echo wp_strip_all_tags( get_the_term_list( $post_id, 'localseomap_project_tag', '', ', ', '' ) ); ?>
					<?php endif; ?>
                </div>
			<?php endif; ?>
        ...
        <div class="profolio-next-prev">
			...
			<?php if ( ! empty( $prev_post ) ) : ?>
                <a href="<?php echo get_the_permalink( $prev_post ); ?>" class="profolio-link profolio-r-link mb30">
                    <span><?php esc_html_e( 'Previous story','localseomap-for-elementor'); ?></span>
			...
			<?php if ( ! empty( $next_post ) ) : ?>
                <a href="<?php echo get_the_permalink( $next_post ); ?>"
                   class="profolio-link profolio-l-link mb30">
                    ...
                    <span><?php esc_html_e( 'Next story','localseomap-for-elementor'); ?></span>
                </a>
			<?php endif; ?>
