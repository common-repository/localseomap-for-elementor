 ...
 * @since  1.0.0
 */
class ProfolioBuilder_Profolio_projects extends Widget_Base {
		...
		foreach ( $result_params as $key => $param ) {
			...
			if ( 'General' === $key ) {
				$this->add_control(
					'filter_terms',
					[
						'label'     => __( 'Filter Terms','localseomap-for-elementor'),
			...
			if ( 'Style' === $key ) {
				$this->add_group_control(
					...
					[
						...
						'label'    => esc_html__( 'Title typography','localseomap-for-elementor'),
						'selector' => '{{WRAPPER}} .profolio-header-xs.profolio-custom-elementor',
					]
				);
				...
				$this->add_group_control(
					...
					[
						...
						'label'    => esc_html__( 'Address typography','localseomap-for-elementor'),
						'selector' => '{{WRAPPER}} .profolio-text-sm',
					]
				);
				...
				$this->add_group_control(
					...
					[
						...
						'label'    => esc_html__( 'Category typography','localseomap-for-elementor'),
						'selector' => '{{WRAPPER}} .profolio-card-category-frame a',
					]
				);
			}
